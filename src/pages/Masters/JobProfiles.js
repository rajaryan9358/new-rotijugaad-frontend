...
const DEFAULTS = { english_name: 150, hindi_name: 150, image: 80, sequence: 80, status: 80, actions: 90 };
...
export default function JobProfiles() {
  ...
  const { colWidths, rHandle } = useResizableColumns('job-profiles-col-widths', DEFAULTS);
